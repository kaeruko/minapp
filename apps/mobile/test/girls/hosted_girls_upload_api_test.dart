...
void main() {
  test(
    'createFromZip sends raw application/zip with exact title query',
    () async {
      ...
      final MockClient client = MockClient((http.Request request) async {
        ...
        return http.Response(
          jsonEncode(<String, Object?>{
            ...
            'owner_user_id': '44444444444444444444444444444444',
            'source_revision': 1,
            'editable': true,
          }),
          201,
  ...
  test('publish sends exact source revision', () async {
    ...
    final String appId = '3' * 32;
    final MockClient client = MockClient((http.Request request) async {
      expect(request.url.path, '/hosted/groups/$groupId/apps/$appId/publish');
