...
void main() {
  test('Novel Host flow keeps JWT outside capability load/save/publish', () async {
    ...
    final GirlsNovelAuthoringApi projectsApi = GirlsNovelAuthoringApi(
    ...
    final List<GirlsNovelProjectSummary> listed = await projectsApi.listProjects(
    ...
    final GirlsNovelProject loaded = await projectsApi.loadProject(
      accessToken: 'owner-token',
      contentId: _contentId,
    );
    expect(loaded.title, '放課後の秘密');
    ...
    expect(launch.contentFormat, minappNovelContentFormat);
