...
class GirlsAuthoringProjectSummary {
  const GirlsAuthoringProjectSummary({
  ...
  factory GirlsAuthoringProjectSummary.fromJson(Map<String, Object?> json) {
    _requireExactFields(
      json,
      const <String>{
        'content_id',
    ...
    return GirlsAuthoringProjectSummary(
...
class GirlsAuthoringProject {
  const GirlsAuthoringProject({
    required this.summary,
    required this.document,
  });

  final GirlsAuthoringProjectSummary summary;
  final Map<String, Object?> document;

  factory GirlsAuthoringProject.fromJson(Map<String, Object?> json) {
    ...
    return GirlsAuthoringProject(
      summary: GirlsAuthoringProjectSummary.fromJson(summaryJson),
      document: Map<String, Object?>.unmodifiable(rawDocument),
    );
  }
}

class GirlsAuthoringProjectsApi {
  GirlsAuthoringProjectsApi({required Uri baseUri, http.Client? client})
  ...
  Future<List<GirlsAuthoringProjectSummary>> listProjects({
    ...
    for (final Object? rawProject in rawProjects) {
      ...
      final GirlsAuthoringProjectSummary project =
          GirlsAuthoringProjectSummary.fromJson(rawProject);
    ...
    return List<GirlsAuthoringProjectSummary>.unmodifiable(projects);
  }

  Future<GirlsAuthoringProject> loadProject({
    required String accessToken,
    ...
    final GirlsAuthoringProject project = GirlsAuthoringProject.fromJson(payload);
  ...
  Future<GirlsAuthoringProjectSummary> createProject({
    required String accessToken,
    required String groupId,
    required String contentFormat,
    ...
    final GirlsAuthoringProjectSummary project =
        GirlsAuthoringProjectSummary.fromJson(payload);
